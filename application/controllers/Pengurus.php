...
class Pengurus extends CI_Controller {
    ...
    public function export()
    {
        ...
        $sheet->setCellValue('A1', "DATA PENGURUS"); // Set kolom A1 dengan tulisan "DATA SISWA"
        $sheet->mergeCells('A1:E1'); // Set Merge Cell pada kolom A1 sampai E1
        $sheet->getStyle('A1')->getFont()->setBold(true); // Set bold kolom A1
        // Buat header tabel nya pada baris ke 3
        $sheet->setCellValue('A3', "NO"); // Set kolom A3 dengan tulisan "NO"
        $sheet->setCellValue('B3', "NAMA PENGURUS"); // Set kolom B3 dengan tulisan "NIS"
        ...
        $sheet->setCellValue('F3', "JABATAN"); // Set kolom E3 dengan tulisan "ALAMAT"
        ...
        $pengurus = $this->M_pengurus->getPengurus()->result_array();

        $no = 1; // Untuk penomoran tabel, di awal set dengan 1
        $numrow = 4;

        foreach ($pengurus as $data) { // Lakukan looping pada variabel siswa
            ...
            $sheet->setCellValue('F' . $numrow, $data['jabatan']);
    ...
    public function index() {
        $data['pengurus'] = $this->M_pengurus->getPengurus()->result_array();

        $this->load->view('templates/header');
        $this->load->view('pengurus/v_tampil', $data);
    ...
    public function edit($id)
    {
        ...
        $data['pengurus'] = $this->M_pengurus->detail($where)->row_array();

        $this->load->view('templates/header');
        $this->load->view('pengurus/v_edit', $data);
        $this->load->view('templates/footer');
        ...
        if (isset($_POST['simpan'])) {
            ...
            $this->M_pengurus->edit($tambah, $where);
            $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible fade show" role="alert">
