...
class M_rekapSpp extends CI_Model {

    function getRekap($bln_start = null, $bln_end = null, $keterangan = 'All') {
        $this->db->select('tb_santri.nama, tb_santri.kelas, tb_pembayaran.bulan, tb_pembayaran.spp, tb_pembayaran.keterangan, tb_pembayaran.tgl');
